...
The per-tab close button, the dirty indicator, ⌘W, and the per-connection scoping of
the tab set MUST continue to behave as specified by the "Center tab system"
requirement, and drag-to-reorder as specified by the "Tab strip drag reordering"
requirement.
