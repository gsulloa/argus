...
On every `vX.Y.Z` tag, the release pipeline publishes a GitHub Release with notes
derived from the changelog (or auto-generated as a fallback) and the four platform
installers attached as assets, idempotently. This gives a human-readable record of
