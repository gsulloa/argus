//! Error helpers for the CloudWatch Logs module.
//!
//! Maps CloudWatch Logs SDK errors to `AppError::Aws`, reusing the DynamoDB
...
/// Map any CloudWatch Logs `SdkError` to `AppError::Aws`.
///
/// Generic over the error type; works for cloudwatch-logs and sts SDK errors.
