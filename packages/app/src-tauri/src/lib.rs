...
use crate::modules::context::commands::{
    context_ai_payload, context_create_folder, context_create_query_folder, context_delete_model,
    context_delete_query, context_delete_query_folder, context_get_object,
    context_get_project_source, context_get_query, context_link_folder, context_list_known_folders,
    context_list_linked_queries, context_list_models, context_list_objects, context_list_queries,
    context_rename_query, context_reveal_path, context_save_model, context_save_query,
...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            context_create_query_folder,
            context_delete_query_folder,
