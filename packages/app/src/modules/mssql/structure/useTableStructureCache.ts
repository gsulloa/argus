/**
 * §21.3 — Per-tab cache for MS SQL Server table structure + DDL.
 *
 ...
 *
 * Invalidation:
 *   - Schema: Refresh → caller calls refreshStructure() / refreshDdl()
 *   - mssql:active-changed (disconnect) → component unmounts
 *   - applyTableEdits success → caller calls refreshStructure()
 *
 * Mirror of src/modules/mysql/structure/useTableStructureCache.ts.
 */
