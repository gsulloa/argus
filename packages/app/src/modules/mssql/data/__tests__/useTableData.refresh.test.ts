/**
 * Tests for "Filter Apply always refetches" requirement — MSSQL engine.
 *
 * Spec: openspec/changes/fix-reapply-same-filter-refetch/specs/mssql-data-grid
 ...
 * still causes a second `mssql_query_table` IPC call.
 */
...
describe("useTableData.refresh() — always refetches (mssql)", () => {
