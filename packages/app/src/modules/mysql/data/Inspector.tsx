/**
 * MySQL Inspector pane — right-side panel showing the focused cell's full value
 * and metadata: truncation info, parsed JSON tree for JSON columns,
 * base64 view for BLOB columns. Mirror of Postgres Inspector.
 *
 * §18.6
 */
        ...
        return (
          <div key={col.name} style={fieldStyle}>
            <div style={fieldHeaderStyle}>
              ...
              {isBin && <span style={tagStyle}>binary</span>}
            </div>
              ...
              {isEnvelope ? (
                ...
                <div
                  style={{
                    ...
                    fontFamily: isBin ? "var(--font-mono, monospace)" : "inherit",
                  }}
                >
                  {formatValue(rawVal)}
                </div>
