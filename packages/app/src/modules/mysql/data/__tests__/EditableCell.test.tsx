...
const decimalCol = col({ name: "amount", data_type: "decimal", column_type: "decimal(10,2)" });
const textCol = col({ name: "note", data_type: "varchar", column_type: "varchar(255)" });
...
describe("MySQL EditableCell - entering edit mode without a change does not commit", () => {
  ...
  it("does not commit an unchanged text cell on Enter", () => {
