/**
 * MySQL useTableData — mirrors Postgres' useTableData.ts.
...
export function useTableData({
  ...
  // Wrap to make it callable like setState
  ...
  // see openspec/changes/fix-reapply-same-filter-refetch/specs/mysql-data-grid
