...
/**
 * Persisted selection shape for MySQL visible schemas.
 * Setting key: `mysqlVisibleSchemas:<connectionId>`
 * System schemas hidden by default: mysql, information_schema, performance_schema, sys.
 */
...
function settingsKey(connectionId: string) {
  return `mysqlVisibleSchemas:${connectionId}`;
}
