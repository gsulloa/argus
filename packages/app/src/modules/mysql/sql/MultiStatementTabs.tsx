/**
 * §20.4 — MySQL MultiStatementTabs.
 *
 * Renders a tab strip for multi-statement run results, mirroring the Postgres
 * component. The active tab defaults to the first failed statement (if any).
 */
