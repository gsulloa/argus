/**
 * Athena QueryEditor component.
 *
 * CodeMirror 6 editor configured for Athena/Presto SQL. Clones the MySQL
 * QueryEditor but uses StandardSQL dialect and Athena completion sources.
 *
 * Key bindings:
