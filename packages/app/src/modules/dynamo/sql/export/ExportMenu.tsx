/**
 * Export menu for DynamoDB PartiQL query results.
 * Dropdown with CSV / JSON Lines / XLSX options.
 * Columns are inferred attribute name strings; rows are AttributeMaps.
 */
...
export function ExportMenu({ connectionName, columns, rows, truncated = false }: Props) {
  ...
  async function handleExport(format: ExportFormat) {
    ...
    try {
      ...
      console.error("[argus.dynamo.sql.export]", e);
