/**
 * DynamoDB PartiQL QueryEditor component.
 *
 * CodeMirror 6 editor configured for PartiQL. PartiQL is SQL-like so we
 * reuse the StandardSQL dialect from @codemirror/lang-sql (same as Athena).
 *
 * Key bindings:
...
// ---------------------------------------------------------------------------
// Error-position underline decoration
// ---------------------------------------------------------------------------
    ...
    useEffect(() => {
      ...
      const state = EditorState.create({
        ...
        extensions: [
          ...
          errorMarkField,
          langCompartment.current.of(sql({ dialect: StandardSQL })),
