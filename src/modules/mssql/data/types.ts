/**
 * MSSQL data-grid types. Most are re-exported from the parent types.ts.
 * This file adds local helpers matching the Postgres/MySQL data/types.ts contract.
 */
...
// ---------------------------------------------------------------------------
// Filter model (in-memory UI model; mirrors MySQL shape — no ILIKE)
// ---------------------------------------------------------------------------
...
/**
 * Cell envelope for binary / truncated values from the MSSQL backend.
 */
...
/** Relation kinds supported by the MSSQL data viewer. */
